      ...
      <Col className="stats-container">
        <Col className="coin-value-statistics">
          <Col className="coin-value-statistics-heading">
            ...
            <p>
              An overview showing the stats of {cryptoDetails.name}, such as the base and quote
        ...
        <Col className="other-value-info">
          <Col className="coin-value-statistics-heading">
            ...
            <p>
              An overview showing the stats of all cryptocurrencies, such as the base and quote
              currency, the rank, and trading volume.
            </p>
          </Col>
